/* =========================================================================
   VÉRTIGO BAR — Mensajes de error (browser)
...
window.VERTIGO_ERRORS = {
  ...
  sin_ronda: 'No hay ninguna ronda activa en este momento.',
  item_invalido: 'Esa opción ya no está disponible. Actualiza la página.',
  artista_invalido: 'No se encontró ese artista.',
  repertorio_vacio: 'Este artista todavía no tiene nada en su repertorio. Agrega al menos una canción/tema/género desde /artista antes de abrir la ronda.',
